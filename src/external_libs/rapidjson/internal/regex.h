...
namespace internal {
    ...
    /*!
        ...
        \note This is a Thompson NFA engine, implemented with reference to
            Cox, Russ. "Regular Expression Matching Can Be Simple And Fast (but is slow in Java,
       Perl, PHP, Python, Ruby,...).", https://swtch.com/~rsc/regexp/regexp1.html
    */
    ...
    private:
        ...
        void Parse(DecodedStream<InputStream>& ds) {
            ...
            *atomCountStack.template Push<unsigned>() = 0;
            ...
            if (stateCount_ > 0) {
                stateSet_ =
                    static_cast<unsigned*>(states_.GetAllocator().Malloc(GetStateSetSize()));
        ...
        bool AddState(Stack<Allocator>& l, SizeType index) const {
            ...
            return s.out == kRegexInvalidState;  // by using PushUnsafe() above, we can ensure s is
                                                 // not validated due to reallocation.
        }
